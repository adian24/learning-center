...
/**
 * This endpoint handles callbacks from Midtrans payment gateway.
 * It verifies the signature and updates the enrollment status based on transaction status.
 *
 * Midtrans sends notifications to this endpoint when payment status changes.
 */
export async function POST(req: NextRequest) {
  try {
    ...
    console.log(
      `Processing callback for order_id: ${order_id}, status: ${transaction_status}`
    );
    ...
    console.log(`Payment type: ${payment_type}, Amount: ${gross_amount}`);
